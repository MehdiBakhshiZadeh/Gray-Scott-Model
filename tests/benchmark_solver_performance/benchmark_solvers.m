...
%
% Output:
%   tests/benchmark_solver_performance/outputs/benchmarks_<timestamp>/benchmark_results.mat
%   tests/benchmark_solver_performance/outputs/benchmarks_<timestamp>/benchmark_table.csv
%
% Note:
...
% -------- Locate this benchmark folder and project root --------
thisFile = mfilename("fullpath");
thisDir  = fileparts(thisFile);   % .../tests/benchmark_solver_performance
...
% Local output root for this benchmark
...
outDir = fullfile(outRoot, "benchmarks_" + string(timestamp));
if ~exist(outDir, 'dir')
    mkdir(outDir);
end
