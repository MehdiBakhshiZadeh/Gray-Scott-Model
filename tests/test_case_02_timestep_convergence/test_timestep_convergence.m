...
thisDir  = fileparts(thisFile);   % .../tests/test_case_02_timestep_convergence
...
meta.d12_L2  = d12_L2;
meta.d24_L2  = d24_L2;
meta.d12_Inf = d12_Inf;
meta.d24_Inf = d24_Inf;
meta.pL2     = pL2;
meta.pInf    = pInf;

% --- Save figure with metadata ---
outFig = fullfile(outDir, "timestep_convergence.png");
